...
export function Footer() {
  return (
    <footer className="w-full max-w-full overflow-x-hidden bg-white dark:bg-slate-950 py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-100 dark:border-slate-800">
